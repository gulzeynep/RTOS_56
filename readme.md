...
*  (Observation): Capture a large snapshot of the running system (at least 500ms). 
...
*  (Final Defense): While developing this complex scenario, what were the 2 biggest 
...
changeable.  
* (Observation): First understand and write down the definitions of all these new 
network related terminology. 
* (Final Defense): Simulate the case when network I/O is successful for both high and 
